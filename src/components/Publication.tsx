...
export default function Publication() {
    return (
        <div>
            <h1 className="text-xl font-bold tracking-tight text-gray-900 dark:text-gray-100">Publications:</h1>
                    ...
                    return ( 
                            <div key={publication.title} className="sm:block rounded-lg px-4 text-sm font-medium shadow-xl shadow-zinc-100/14 ring-1 mb-6">
                                <a href={publication.url.toString()} target="_blank">
                                        <b><h1 className="text-xl font-bold tracking-tight text-gray-900 dark:text-gray-100 w-full p-2 mt-0 mb-0 md:mt-2 md:mb-0 mx-auto">{publication.title}</h1></b>
